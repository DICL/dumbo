...
r = requests.get('http://'+ambari_url+':8080/api/v1/clusters/'+items["cluster_name"]+'/services/YARNAPPMONITOR/components/YARNAppMonitorClient', headers=headers, auth=('admin', 'admin'))
j = json.loads(r.text)
result =[]
