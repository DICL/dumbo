...
class MyTCPHandler(SocketServer.BaseRequestHandler):
  def handle(self):
    ...
    if(str(self.data)=='kernelinstall'):
      lustreFSKernelInstall.subprocess_open('echo "kernelinstall" >> /tmp/dm-log.info')
      lustreFSKernelInstall.kernelInstall()
