...
class PlotlyJS extends Component{
  ...
  // plotly js 그리기
  draw(){
    const { data , grape_data} = this.props;
    console.log(this.props);
    this.chart_data = data;

    let olderTime = data.min;
    let futureTime = data.max;
    ...
    this.chart = Plotly.plot( this.appRef.current , grape_data , chart_layout, chart_option );
  }
