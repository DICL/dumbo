 ...
 */
class CSVFileFormat extends TextBasedFileFormat with DataSourceRegister with Serializable {
...
private[csv] class CsvOutputWriter(
    ...
    params: CSVOptions) extends OutputWriter with Logging with Serializable {
