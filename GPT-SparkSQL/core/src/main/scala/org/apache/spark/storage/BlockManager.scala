...
private[spark] class BlockManager(
  ...
  def initialize(appId: String): Unit = {
    ...
    blockReplicationPolicy = {
      ...
      logDebug(s"Using $priorityClass for block replication policy")
      ret
    }
    ...
    shuffleServerId = if (externalShuffleServiceEnabled) {
      logDebug(s"external shuffle service port = $externalShuffleServicePort")
    ...
    logDebug(s"Initialized BlockManager: $blockManagerId")
  }

  private def registerWithExternalShuffleServer() {
    logDebug("Registering executor with local external shuffle service.")
  ...
  private def reportAllBlocks(): Unit = {
    logDebug(s"Reporting ${blockInfoManager.size} blocks to the master.")
  ...
  def reregister(): Unit = {
    ...
    logDebug(s"BlockManager $blockManagerId re-registering with master")
  ...
  def replicateBlock(
    ...
    logDebug(s"Using $blockManagerId to pro-actively replicate $blockId")
