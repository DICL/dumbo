...
class SparkContext(config: SparkConf) extends Logging {
  ...
  // GPT implementation
  var currentSessionState: Object = None
  def setCurrentSessionState(curSession: Object) : Unit = { currentSessionState = curSession}
  def getCurrentSessionStage() : Object = { this.currentSessionState }
