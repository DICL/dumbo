...
public class RawLocalFsL extends DelegateToFileSystem{
    ...
    RawLocalFsL(final URI theUri, final FileSystem fs, final Configuration conf,boolean authorityRequired) throws IOException, URISyntaxException{
    ...
    RawLocalFsL(final Configuration conf) throws IOException, URISyntaxException {
       ...
       */
    RawLocalFsL(final URI theUri, final Configuration conf) throws IOException,
          URISyntaxException {
