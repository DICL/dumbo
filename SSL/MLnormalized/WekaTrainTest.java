...
//			System.out.println(aaa);
		...
		public double predict(double[] Arr) throws Exception{
			Instance iTest = WekaHelper.convertArr2InstancePredict(Arr);
			double result = cModel.classifyInstance(iTest);
			return result;	
		}
		public double predict1(Instance a) throws Exception{
			return  cModel.classifyInstance(a);
		}
